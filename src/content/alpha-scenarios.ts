...
export const ALPHA_SOURCE_PACK_VERSION = '2026-08-26.final-review-v1'
...
export const alphaSources: AlphaSource[] = [
  ...
  {
    key: 'eds-personal-issuance-2025',
    language: 'ru',
    publisher: 'Қазақстан Республикасының Ұлттық куәландырушы орталығы',
    ...
    validFrom: '2025-06-27T19:00:00.000Z',
  },
  {
  ...
  {
    key: 'residence-current-guide',
    language: 'ru',
    publisher: 'Қазақстан Республикасының электрондық үкіметі',
    sourceType: 'government',
    title: 'Тұрақты және уақытша тіркеудің қолданыстағы арналары мен құжаттары',
    trustTier: 'primary-official',
    url: 'https://www.gov.kz/situations/424/1044?lang=ru',
  },
  {
...
export const alphaScenarioDrafts: AlphaScenarioDraft[] = [
  {
    ...
    cost: {
      ...
      explanation: 'ЭЦҚ кілтін алу тегін.',
      kind: 'free',
    },
    documents: [
      {
      ...
      claims: [
        {
          ...
          evidence:
            'eGov пен НУЦ қашықтан алу үшін жарамды құжат, SMS қабылдайтын телефон, камера және NCALayer қажет екенін бірдей көрсетеді.',
          id: 'EDS-01',
          sourceKeys: ['eds-remote-egov', 'eds-remote-nca', 'eds-ncalayer'],
          statement: 'ЭЦҚ-ны биометриялық сәйкестендіру арқылы қашықтан алуға болады.',
        },
        {
          disposition: 'included',
          evidence:
            'eGov қашықтан сәйкестендіру сәтсіз болғанда құжат модерациясын бір жұмыс күні ішінде өткізетінін көрсетеді.',
          id: 'EDS-02',
          sourceKeys: ['eds-remote-egov'],
          statement:
            'Құжат модерацияға жіберілсе, оператор тексеруі бір жұмыс күніне дейін созылады.',
        },
        {
          disposition: 'included',
          evidence:
            'НУЦ 2025 жылғы 28 маусымнан бері кілтті тек иесінің өзі алатынын, биометрияға бес әрекет берілетінін және сәтсіз болса ХҚКО-ның өзіне-өзі қызмет көрсету секторына жеке баруға болатынын хабарлайды.',
          id: 'EDS-03',
          sourceKeys: ['eds-personal-issuance-2025'],
          statement:
            'Сенімхат арқылы алу жоқ; бес сәтсіз биометрия әрекетінен кейін иесі ХҚКО-ға өзі барады.',
        },
        {
          disposition: 'included',
          evidence:
            'НУЦ ортақ компьютерден кілтті өшіруді, сенімді пароль қолдануды және кілтті үшінші тұлғаға бермеуді талап етеді.',
          id: 'EDS-04',
          sourceKeys: ['eds-personal-issuance-2025'],
          statement: 'ЭЦҚ кілті мен паролін басқа адамға беруге болмайды.',
        },
      ],
      primarySourceKeys: [
        'eds-remote-egov',
    ...
    processingTime: {
      ...
      value: 'Онлайн; құжат модерацияға жіберілсе — 1 жұмыс күніне дейін',
    },
    requirements: [
  ...
  },
  {
    ...
    editorial: {
      ...
      publicationBlockers: [
        'Қазақша мәтінді тәуелсіз редактор тексеруі керек.',
        'Меншік иесі және жалға алушы жолдарын авторизацияланған eGov пен кемінде бір банк қолданбасында тексеру керек.',
    ...
    eligibility: [
      {
        condition: 'Жеке тіркеу 14 жастан басталады.',
        explanation:
          '14 жасқа толмаған бала тұрғылықты жері бойынша бөлек тіркелмейді; оның тұрғылықты жері заңды өкілінің мекенжайымен айқындалады.',
      },
      {
    ...
    evidence: {
      claims: [
        ...
        },
        {
          disposition: 'included',
          evidence:
            'Қолданыстағы қызмет карточкалары тұрақты және уақытша тіркеудің тегін әрі портал арқылы 15 минут ішінде көрсетілетінін айтады; 2026 жылғы нұсқаулық ХҚКО мен банк қолданбаларын да қолжетімді арна ретінде көрсетеді.',
          id: 'RES-02',
          sourceKeys: [
          ...
          statement: 'Тіркеудің құны, ресми арналары және онлайн қызмет мерзімі.',
        },
        {
          disposition: 'included',
        ...
        },
        {
          disposition: 'included',
          evidence:
            'Қолданыстағы мемлекеттік нұсқаулық 14 жасқа толған азаматтарды тіркеуге жатқызады және 14 жасқа толмаған баланың тұрғылықты жерін заңды өкілінің мекенжайымен байланыстырады.',
          id: 'RES-04',
          sourceKeys: ['residence-current-guide'],
          statement: 'Тұрғылықты жері бойынша жеке тіркеу 14 жастан басталады.',
        },
      ],
      primarySourceKeys: [
        'residence-rules',
    ...
    faq: [
      ...
      {
        answer:
          'Жоқ. 14 жасқа толмаған бала бөлек тіркелмейді; оның тұрғылықты жері ата-анасының немесе басқа заңды өкілінің мекенжайымен айқындалады.',
        question: '14 жасқа толмаған баланы бөлек тіркеу керек пе?',
      },
    ],
    officialLinks: [
      {
    ...
    processingTime: {
      explanation:
        'Үй сіздікі болмаса, меншік иесі өтінім тіркелгеннен кейін оны 1 сағат ішінде растауы керек; растау болмаса, өтінім автоматты түрде қабылданбайды.',
      value: 'Портал арқылы 15 минут ішінде',
    },
    requirements: [
      'Онлайн өтініш үшін мобильді азаматтар базасында тіркелген нөмір немесе ЭЦҚ дайындаңыз.',
      'Меншік иесі өтінімді тіркелгеннен кейін 1 сағат ішінде растауға дайын болуы керек.',
    ...
    shortAnswer:
      '14 жастан бастап тұрақты көшсеңіз — жаңа мекенжайға тұрақты тіркеліңіз. Бір айдан ұзақ уақытша тұрсаңыз — келген күннен бастап 10 күн ішінде уақытша тіркеліңіз. Қызмет тегін және онлайн қолжетімді; үй сіздікі болмаса, меншік иесінің келісімі қажет.',
    ...
    steps: [
      ...
      },
      {
        ...
        description:
          'Ресми беттен онлайн өтініш беріңіз. Қызмет eGov-та және қолдау көрсетілетін банк қолданбаларында қолжетімді; қажет болса, ХҚКО-ға жүгінуге болады.',
        title: 'Уақытша тіркеуге өтініш беріңіз',
      },
    ],
    title: 'Тұрғылықты жерге қалай тіркелуге болады?',
    whoIsItFor:
      'Қазақстанда жаңа тұрақты мекенжайға көшкен немесе басқа мекенжайда бір айдан ұзақ уақытша тұратын 14 жасқа толған азаматқа.',
  },
  {
    category: {
      description: 'Тіркеу, құжаттар және мемлекеттік рәсімдер.',
  ...
  },
  {
    ...
    eligibility: [
      {
        condition: 'Қазақстан Республикасының азаматы немесе қандассыз.',
        explanation: 'Бұл арнаулы салық режимі азаматтар мен қандастарға арналған.',
      },
      {
      ...
      claims: [
        {
          disposition: 'included',
          evidence:
            'Жаңа Салық кодексі мен КГД түсіндірмесі режимнің шарттарын: ҚР азаматы немесе қандас, ЖК емес, жұмыскерсіз, рұқсат етілген қызмет және айына 300 АЕК деп көрсетеді.',
          id: 'BIZ-01',
          sourceKeys: ['tax-code-2026', 'self-employed-kgd-2026'],
          statement: 'Өзін-өзі жұмыспен қамту режимінің негізгі шарттары.',
        },
        {
          disposition: 'included',
    ...
    requirements: [
      'ҚР азаматы немесе қандас мәртебеңіз бар-жоғын тексеріңіз.',
    ...
    seo: {
      description:
        '2026 жылы ЖК ашу керек пе, әлде өзін-өзі жұмыспен қамту режимі жарай ма: негізгі шарттар, табыс шегі және ресми тіркеу жолы.',
      noIndex: true,
      title: 'ЖК ме, әлде өзін-өзі жұмыспен қамту ма? — QALAI',
    },
    shortAnswer:
      'Егер ҚР азаматы немесе қандас болсаңыз, ЖК ретінде тіркелмесеңіз, қызметкер жалдамасаңыз, қызметіңіз рұқсат тізімінде болса және айлық табыс 300 АЕК-тен аспаса, өзін-өзі жұмыспен қамту режимі жарауы мүмкін. Осы шарттардың бірі орындалмаса, ЖК немесе басқа нысанды таңдаңыз.',
    slug: 'zhk-nemese-ozin-ozi-zhumyspen-kamtu',
    steps: [
      {
        description:
          'Мәртебе, ЖК тіркеуі, жалдамалы жұмыскер, қызмет түрі және айлық табыс шарттарының бәрін салыстырыңыз.',
    ...
    whoIsItFor:
      '2026 жылы Қазақстанда жалғыз өзі табыс табуды немесе шағын кәсіп бастауды жоспарлап, заңды нысанды таңдап жүрген ҚР азаматына немесе қандасқа.',
  },
