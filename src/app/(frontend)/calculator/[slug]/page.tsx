          ...
          <>
            ...
            <section className="calculator-explanation">
              ...
              <p>
                ...
                қызметкердің бір жұмыс берушіден 2026 жылы 12 ай бойы алатын тұрақты жалақысын
                болжайды: 10% міндетті зейнетақы жарнасы, 2% МӘМС жарнасы, 30 АЕК базалық шегерім
                және ЖТС-тың жылдық прогрессивті шкаласы. Бір жолғы сыйақы, басқа табыс көздері,
                ерекше әлеуметтік шегерімдер және жұмыс беруші төлейтін аударымдар бұл нұсқаға
                кірмейді. Салық салынатын табыс 8 500 АЕК жылдық шектен асқанда калькулятор жылдық
                ЖТС-ты 12 айға бөліп, орташа айлық соманы көрсетеді; нақты айлардағы ұсталым әртүрлі
                болуы мүмкін.
              </p>
              <ul className="official-source-list">
                <li>
