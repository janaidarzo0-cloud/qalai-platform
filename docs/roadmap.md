...
|     2 | Жеке куәлігімнің мерзімі бітті немесе жоғалды. Қалай ауыстырамын?                     | Medium | Reason-first route; do not hard-code the disputed fee until checkout/source reconciliation     | [eGov situation](https://beta.egov.kz/situations/22/intro?lang=kk), [online replacement window](https://www.gov.kz/situations/22/1556), [loss or theft](https://egov.kz/cms/kk/articles/vost_udv)                                                                                                         |
...
| 7–8 | Author and evidence the five alpha Scenarios; mobile and official-link QA for each                                  |
